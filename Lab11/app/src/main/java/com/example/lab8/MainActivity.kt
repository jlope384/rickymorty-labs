...
import com.example.lab8.layouts.screen3.characterDetailScreen
import com.example.lab8.layouts.screen3.navigateToCharacterDetailScreen
            ...
            Lab8Theme {
                Surface(
                    ...
                    Scaffold(
                        ...
                        NavHost(
                            navController = navController,
                            startDestination = if (loggedIn) CharacterDestination else LoginDestination,
